...
public class UIEstudiante extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < listaE.size(); i++) {
            ...
            mostrar += estudiante.getNombreP() + ", "
                    + estudiante.getTelefonoP() + ", "
                    + estudiante.getCorreoP() + ", "
                    + estudiante.getCodigoE() + ", "
                    + estudiante.getCarreraE() + "\n";
        }
        jTextArea1.setText(mostrar);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:String nombreE = jTextField1.getText();
        String telefonoE = jTextField2.getText();
        String correoE = jTextField3.getText();
        String codigoE = jTextField4.getText();
        String carreraE = jTextField5.getText();
